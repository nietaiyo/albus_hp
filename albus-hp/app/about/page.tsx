      ...
      <div style={{ maxWidth: '800px', margin: '48px auto' }}>
        ...
        <section style={{ marginBottom: '64px' }}>
          ...
          <h1 style={{ fontSize: '36px', marginBottom: '24px', lineHeight: '1.3' }}>
            テクノロジーで、<br />日常の「お祭り」をもっと身近に。
          </h1>
          <p className="sectionText" style={{ fontSize: '16px', lineHeight: '1.8', color: '#4b5563' }}>
            私たちは、大学生活の集大成である「白鷺祭」をテクノロジーの力でサポートしたいという強い情熱から結成されました。
            「お祭りの情報がどこにあるかわからない」「もっとディープな楽しみ方を知りたい」といった課題を、
            学生ならではの視点と、確かな技術力で解決します。
            ただ便利なだけでなく、触っていてどこかワクワクするような、温かみのあるデジタルプロダクトを目指しています。
          </p>
        </section>
